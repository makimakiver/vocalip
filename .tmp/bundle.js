...
var useBufferUntilFirstFrame = ({
  ...
  const bufferUntilFirstFrame = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((requestedTime) => {
    ...
    if (current.readyState >= current.HAVE_FUTURE_DATA && !isSafariWebkit() && !isDesktopChrome()) {
      playbackLogging({
        logLevel,
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "forma_vocis:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkforma_vocis"] = self["webpackChunkforma_vocis"] || [];
...
function MyComposition({ caption, voiceUrl }) {
  const [currentWord, setCurrentWord] = (0,react.useState)("");
  const [currentWordIndex, setCurrentWordIndex] = (0,react.useState)(0);
  const currentFrame = (0,esm.useCurrentFrame)();
  const fps = (0,esm.useVideoConfig)().fps;
  const getCurrentWord = () => {
    const currentWord2 = caption.find((word) => word.start <= currentFrame / fps && word.end >= currentFrame / fps);
    if (currentWord2) {
      return currentWord2.word;
    }
    return "";
  };
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: {
    backgroundColor: "black"
  } }, /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "80px", fontSize: "24px" } }, /* @__PURE__ */ react.createElement("h2", { style: { color: "white" } }, getCurrentWord())), /* @__PURE__ */ react.createElement(esm.Audio, { src: voiceUrl }));
}
/* harmony default export */ const Composition = (MyComposition);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 517).then(__webpack_require__.bind(__webpack_require__, 4517)).then(({ StudioInternals }) => {
