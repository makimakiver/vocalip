...
declare class SDK {
     ...
     */
    tokenTokenIdTokenGet(metadata: types.TokenTokenIdTokenGetMetadataParam): Promise<FetchResponse<200, types.TokenTokenIdTokenGetResponse200>>;
    /**
     ...
     */
    tokenTokenPost(body: types.TokenTokenPostBodyParam, metadata?: types.TokenTokenPostMetadataParam): Promise<FetchResponse<201, types.TokenTokenPostResponse201>>;
    /**
     ...
     */
    tokenTokenIdAuthorizationBrandIdAuthorizationGet(metadata: types.TokenTokenIdAuthorizationBrandIdAuthorizationGetMetadataParam): Promise<FetchResponse<200, types.TokenTokenIdAuthorizationBrandIdAuthorizationGetResponse200>>;
    /**
     ...
     */
    tokenTokenIdAuthorizationBrandIdAuthorizationDelete(metadata: types.TokenTokenIdAuthorizationBrandIdAuthorizationDeleteMetadataParam): Promise<FetchResponse<204, types.TokenTokenIdAuthorizationBrandIdAuthorizationDeleteResponse204>>;
    /**
     ...
     */
    tokenTokenIdAuthorizationAuthorizationPost(body: types.TokenTokenIdAuthorizationAuthorizationPostBodyParam, metadata: types.TokenTokenIdAuthorizationAuthorizationPostMetadataParam): Promise<FetchResponse<201, types.TokenTokenIdAuthorizationAuthorizationPostResponse201>>;
    /**
     ...
     */
    tokenTokenIdMediaMediaIdMediaGet(metadata: types.TokenTokenIdMediaMediaIdMediaGetMetadataParam): Promise<FetchResponse<200, types.TokenTokenIdMediaMediaIdMediaGetResponse200>>;
    /**
     ...
     */
    tokenTokenIdMediaMediaIdMediaPatch(body: types.TokenTokenIdMediaMediaIdMediaPatchBodyParam, metadata: types.TokenTokenIdMediaMediaIdMediaPatchMetadataParam): Promise<FetchResponse<200, types.TokenTokenIdMediaMediaIdMediaPatchResponse200>>;
}
