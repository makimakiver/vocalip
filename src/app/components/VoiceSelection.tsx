  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{ marginTop: "0.25rem", fontSize: "0.8rem", color: "#888" }}
        >
        ...
        <motion.button
          ...
          style={{
            ...
            cursor: "pointer",
            boxShadow:
              "0 0 5px #ff00cc, 0 0 10px #3333ff, inset 0 0 5px rgba(255,255,255,0.2)",
            textTransform: "uppercase",
            letterSpacing: "1px",
          }}
        >
          {free ? "Use License for Free" : `Buy license for ${mintingFee} IP`}
        </motion.button>
      </div>
    </motion.div>
  );
